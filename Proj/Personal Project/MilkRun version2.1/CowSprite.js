function MAINGAME(){ 
	...
	function MuddyPigLoop(){
		setTimeout(function(){
			...
			if( ((Pig.x < (Cow.x+50) && Pig.x > Cow.x) || ((Pig.x+(539*Pig.size))< (Cow.x+50) && (Pig.x+(539*Pig.size))> Cow.x)) && (Cow.y+50) > Pig.y ){
	...
	function FlyingDuckLoop(){
		setTimeout(function(){
			...
			if((f_duck.x < (Cow.x+50)  && (f_duck.x) > Cow.x) || ((f_duck.x+(541*f_duck.size))< (Cow.x+50) && (f_duck.x+(541*f_duck.size))> Cow.x)){
				if((f_duck.y < (Cow.y+50)  && (f_duck.y) > Cow.y) || ((f_duck.y+(521*f_duck.size))< (Cow.y+50) && (f_duck.y+(521*f_duck.size))> Cow.y)){
					window.location.href="GameOver.html";
				};
			};
		}, 1000 / fps);
	...
	function BarnLoop(){
		setTimeout(function(){
			...
			if( (((barn.x) < (Cow.x+50)  && (barn.x) > Cow.x) || ((barn.x+(615*barn.size))< (Cow.x+50) && (barn.x+(615*barn.size))> Cow.x)) && (Cow.y+45) > barn.y ){
				window.location.href="GameOver.html";
			};
		}, 1000 / fps );
	}
	...
	function DucksLoop(){
		setTimeout(function(){
			ctx10.clearRect(0,350,1000,150);
			...
			if( ((w_ducks.x < (Cow.x+50)  && (w_ducks.x) > Cow.x) || ((w_ducks.x+(w_ducks.width*w_ducks.size))< (Cow.x+50) && (w_ducks.x+(1201*w_ducks.size))> Cow.x)) && (Cow.y+50) > w_ducks.y ){
				window.location.href="GameOver.html";
			};
		}, 1000 / (fps*10));
	}
