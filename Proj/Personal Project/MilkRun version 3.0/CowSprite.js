function MAINGAME(){ 
	...
	function Collision(Animal){
		if((Animal.x < (Cow.x+30)  && (Animal.x) > Cow.x) || ((Animal.x+(541*Animal.size))< (Cow.x+30) && (Animal.x+(541*Animal.size))> Cow.x)){
			if((Animal.y < (Cow.y+45)  && (Animal.y) > Cow.y) || ((Animal.y+(521*Animal.size))< (Cow.y+45) && (Animal.y+(521*Animal.size))> Cow.y)){
